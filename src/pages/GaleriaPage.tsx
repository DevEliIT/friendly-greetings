...
export default function GaleriaPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Galeria - Nós Dois</title>
        <meta name="description" content="Nossa galeria de fotos, vídeos e memórias." />
      </Helmet>
      ...
      <MainLayout>
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8 flex items-center gap-3">
            ...
            <h1 className="font-display text-3xl font-semibold">Galeria Completa</h1>
          </div>
